...
class ManajerRekomendasi:
    ...
    # ----------------------------------------------------------
    # catat_pinjam â€” tambahkan isbn ke sesi aktif anggota
    # dan langsung update edge ko-pinjam dengan buku sebelumnya.
    # Big-O Waktu : O(k * deg) â€” k = buku aktif anggota ini
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # catat_kembalikan â€” hapus isbn dari sesi aktif anggota
    # Big-O Waktu : O(k) â€” k = buku aktif anggota
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # rekomendasikan â€” BFS dari isbn, max 2 hop
    # Big-O Waktu : O(V + E)
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # info_graf â€” statistik graf untuk laporan eksperimen
    # Big-O Waktu : O(V + E)
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # format_rekomendasi â€” ubah hasil rekomendasikan ke string CLI
    # ----------------------------------------------------------
    @staticmethod
