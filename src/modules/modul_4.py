...
def rekomendasikan(
    ...
    hasil_bfs = self._graf.rekomendasikan(
        isbn,
        max_hop,
        min_bobot
    )
    ...
    for isbn_rek, bobot, hop in hasil_bfs:
        ...
        # tambahkan info judul dari BST
        if manajer_katalog is not None:

            hasil_cari = manajer_katalog.cari_buku(
                isbn_rek
            )
